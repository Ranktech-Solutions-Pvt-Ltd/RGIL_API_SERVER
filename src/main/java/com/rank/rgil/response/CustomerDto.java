 ...
 * @author Sukanta
 * @since 04-Dec-2018
 * @Purpose the following Class is used for storing CustomerMst Entity data
 */
...
public class CustomerDto implements Serializable {
    ...
    private String callRecordLink;
    private boolean renderDownloadLink;
    ...
    public String getCallRecordLink() {
        return callRecordLink;
    }

    public void setCallRecordLink(String callRecordLink) {
        this.callRecordLink = callRecordLink;
    }

    public boolean getRenderDownloadLink() {
